    ...
    Tawk_API.onLoad = function(){
        setTimeout(function() {
            ...
            Tawk_API.setAttributes({
                    ...
                    <?php $count = 0; foreach ($cart_data as $key => $value) : ?>
                    'item-<?php echo ($count+1); ?>' : '<?php echo $value['name']; ?>',
                    'item-<?php echo ($count+1); ?>-quantity' : '<?php echo $value['quantity']; ?>',
                    'item-<?php echo ($count+1); ?>-price' : '<?php echo $value['price']; ?>',
                    'item-<?php echo ($count+1); ?>-total' : '<?php echo $value['total']; ?>',
                    <?php endforeach; ?>
                }, function(error){
                    console.log(error);
                });
