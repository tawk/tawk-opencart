...
1. Download and extract the tawkto1.5.6.x.zip
...
3. Install extension from Extensions -> Module menu
4. Go to Extensions ->Modules -> Tawk.to -> Edit and choose widget you want to use, you can choose different widgets for different stores
...
= 1.0.1 =
* If customer is authorized, visitor info will be pre-populated
